 ...
 */
var shuffleToken = function shuffleToken(token) {
...
var Authentication = /*#__PURE__*/function () {
  ...
  _createClass(Authentication, null, [{
     ...
     */
    function () {
      var _getToken = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(payload) {
        var expiresIn,
          token,
          scrambledToken,
          _args = arguments;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              expiresIn = _args.length > 1 && _args[1] !== undefined ? _args[1] : '24h';
            ...
            case 4:
              scrambledToken = _context.sent;
              return _context.abrupt("return", scrambledToken);
            case 6:
            case "end":
    ...
    value: function () {
      var _verifyToken = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(token) {
        var reshuffledToken, output;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              reshuffledToken = shuffleToken(token);
              output = {};
              return _context2.abrupt("return", _jsonwebtoken["default"].verify(reshuffledToken, process.env.JWT_SECRET, function (err, decoded) {
                if (err) {
                  output = {
